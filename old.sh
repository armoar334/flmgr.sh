...
DRAW_TXT() {
	# just an observation, but this is ridiculously fast for bash. i ran it in a window on a vertical 4k screen and it did it instantly. i also tried it horizontal on an 8k virtual display and had the same result. wild
...
DRAW_IMAGE() {
	...
	then
		...
		"width = $WIDTH" \
		"height = auto" \
		"name = $FILENAME" # This mf aint work!!!!!
	else
